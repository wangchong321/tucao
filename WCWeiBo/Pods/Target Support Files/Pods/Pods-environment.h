...
// SwiftQRCode
#define COCOAPODS_POD_AVAILABLE_SwiftQRCode
#define COCOAPODS_VERSION_MAJOR_SwiftQRCode 1
#define COCOAPODS_VERSION_MINOR_SwiftQRCode 0
#define COCOAPODS_VERSION_PATCH_SwiftQRCode 1
